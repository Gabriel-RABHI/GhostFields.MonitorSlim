...
System.Environment.CurrentManagedThreadId seems to not be reliable on Linux ! If a GC collect is done, or something like that, it can return a different ID at two different time...
